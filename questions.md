...
## Cyber Security Engineer, Jaguar Land Rover
> 3 July 2020

<details><summary>Questions about the resume</summary>
<p>
...
What I understand and know about few infosec concepts
...
<details><summary>What is CSRF vulnerability?</summary>
<p>

- CSRF is a web security vulnerability that allows an attacker to induce users to perform actions that they do not intend to perform. Similarly, I further explained it with example. Less
...
<details><summary>What is XSS vulnerability?
...
3.REST APIs -Diff GET vs POST
4.Normalization.
5.What are the indexes.
6.Will views be updated if we update table.

## Security Implementation Engineer, GuidePoint Security
> 1 June 2020

What is something you think about.

## Security Engineer, Google
> 29 May 2020

<details><summary>What happens when you go to google.com</summary>
<p>
...
## Senior Information Security Engineer (Applications), BigCommerce
> 29 May 2020

All the questions were very basic such as "what happens when you type a url in the browser and press enter" etc.

## Junior Applications security Engineer, Backbase
> 29 May 2020

what do you look to get out of this position?
...
- The ones that I am wearing.   Nike Air Max Axis.  Make sure you are sporting the brand and you know why you are wearing it. Less
...
Technical round: 
1. XSS and mitigation 
2. SQLi
3. Credential based attacks & mitigation 
4. Bash scripts 

Coding round: 
1. The question was related to graphs.

## Cyber Security Engineer, Novetta
> 23 May 2020

Simple computer science/info technology type questions (OSI model, how dns works, etc.)
...
## Network Security Engineer, Fortego, a BlueHalo Company
> 15 May 2020

Experience based questions and other technical knowledge questions to understand where I truly sat with what I know.

## Senior Security Engineer, Form3 Financial Cloud
> 13 May 2020

Some low-level technical details about cryptography.

## Security Engineer, Taxfix
> 7 May 2020

How to reduce IAM complexity in the GCP environment?
...
Questions on ACLs
How to block only one way traffic
F5 load balancers-persistence
DDOS, site to site VPN's
...
How DNS works from your laptop like how google.com can access from your kaptop
Where to apply ACL on interfaces
Tcp flags
Subnetting
 tcp flags
...
VPN
port numbers
what is public key and private key in certficates
ACLs-when to apply inbound and when to apply outbound
...
## Security Engineer, Ebury Partners
> 17 March 2020
...
## Applications Security Engineer, Hotstar
> 12 March 2020

Mobile app security 
web app security 
Live challenges to solve which had XSS,LFI,SQL and other attacks on a Rails application

## Information Security Engineer, Travelport
> 11 March 2020

What is SSL and working in detail?
Explain Buffer overflow and underflow attack? How do we mitigate it?
How to secure a service?
What is difference between symmetric and Asymmetric encryption?
What are mobile owasp top 10 ? Explain Obfuscation?

## Senior Security Engineer, UST
> 9 March 2020

Basics of the security domain

## Cyber Security Engineer, Samsung Research America
> 7 March 2020

What do you expect of the role you're applying to.
...
## Cyber Security Engineer, LPL Financial
> 5 March 2020

What did I see in the company and the position?

## Security Engineer, Booking.com
> 4 March 2020

Describe web application bugs

## Security Engineer, Amazon
> 3 March 2020

In depth scenario about how I might find evidence of malicious activity within the AWS EBS service. Interviewer used almost the whole hour to dig in on this.

## Associate Security Engineer, Workday
> 3 March 2020

<details><summary>Why do you want to work in security?</summary>
<p>

- They asked what I knew about security topics I had previously researched for a club Less
...
<details><summary>What is your involvement in your clubs?</summary>
<p>
...
## Security Engineer, Urban Outfitters
> 1 March 2020

what do you think is the biggest problem of our platform?
...
Write a program to find given string in file and print line number

## Software Security Engineer
> 26 February 2020

Second round:
Write a program to print all files in directory and sub directories with .zip extension along with full path
